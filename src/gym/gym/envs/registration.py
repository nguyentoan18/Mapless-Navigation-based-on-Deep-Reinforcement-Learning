...
class EnvSpec(object):
    ...
    def __init__(self, id, entry_point=None, trials=100, reward_threshold=None, local_only=False, max_episode_steps=None, kwargs=None, nondeterministic=False, tags=None, timestep_limit=None):
        self.id = id
